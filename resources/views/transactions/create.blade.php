                    ...
                    <form action="{{ route('transactions.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="date" name="transaction_date" id="transaction_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('transaction_date') border-red-500 @enderror" value="{{ old('transaction_date', date('Y-m-d')) }}" required>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="type" id="type" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('type') border-red-500 @enderror" required>
                            ...
                            <div class="mb-4 md:col-span-2">
                                ...
                                <select name="item_id" id="item_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('item_id') border-red-500 @enderror" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="qty" id="qty" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('qty') border-red-500 @enderror" value="{{ old('qty', 1) }}" min="1" required>
                                @error('qty')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4 md:col-span-2" id="supplier-wrapper">
                                ...
                                <select name="supplier_id" id="supplier_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('supplier_id') border-red-500 @enderror">
