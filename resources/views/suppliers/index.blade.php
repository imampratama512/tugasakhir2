            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 border-b border-gray-200">
                    ...
                    <div class="flex justify-between mb-4">
                        ...
                        <a href="{{ route('suppliers.create') }}" class="px-4 py-2 bg-teal-600 text-white rounded hover:bg-teal-700">Tambah Supplier</a>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr>
                                    ...
                                    <th class="py-2 px-4 border-b">Nama Supplier</th>
                            ...
                            <tbody>
                                @forelse($suppliers as $supplier)
                                    <tr>
                                        ...
                                        <td class="py-2 px-4 border-b text-center">
                                            <a href="{{ route('suppliers.edit', $supplier->id) }}" class="bg-teal-600 text-white px-3 py-1 rounded-lg text-xs hover:bg-teal-700 transition mr-2 font-semibold shadow-sm">Edit</a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="py-2 px-4 border-b text-center text-gray-500">Belum ada data supplier.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
